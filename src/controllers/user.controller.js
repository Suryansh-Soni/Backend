...
import { ref } from "process"; // This iport is not used in the code, but it seems to be a mistake.
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .jasonI(new ApiRes(200, channel[0], "User channel fetched successfully"));
});
...
const getWatchHistory = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiRes(200, user[0].watchHistory, "watch history fetched"));
});
